const CACHE='miv-calendria-v1';
const APP=['./','./index.html','./manifest.webmanifest','./pwa-assets/icon-192.png','./pwa-assets/icon-512.png','./pwa-assets/apple-touch-icon.png','https://cdn.sheetjs.com/xlsx-0.20.3/package/dist/xlsx.full.min.js'];
